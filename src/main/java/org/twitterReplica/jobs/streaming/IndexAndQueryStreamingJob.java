...
/*
 * 	Queries images fromt he Twitter Streaming API and then indexes them
 */
public class IndexAndQueryStreamingJob {

	static Logger logger = Logger.getLogger(IndexAndQueryStreamingJob.class);
	...
	public static void main(String[] args) {
		...
		int rank = Integer.valueOf(args[23]);
		...
		// Schedule streaming
		detector.indexAndQueryStreaming(spark, consumerKey, consumerSecret, 
