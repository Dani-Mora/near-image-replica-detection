...
# Description:
# This job indexes the images from the input folder and appends this data to the already indexed one
# It assumes that:
...
# Finally it queries a set of images contained in a folder (all files must be valid images).
...
QUERY_FOLDER=/path/to/query/folder # Folder containing images to query
